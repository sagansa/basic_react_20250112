...
export default function AuthenticatedLayout({ header, children }) {
    ...
    // Tambahkan useEffect untuk dark mode
    useEffect(() => {
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="flex items-center shrink-0">
                                <Link href="/">
                                    <ApplicationLogo className="block w-auto h-9 text-gray-800 fill-current dark:text-gray-200" />
                                </Link>
                            </div>
                                        ...
                                        <Dropdown>
                                            <Dropdown.Trigger>
                                                <span className="inline-flex rounded-md">
                                                    <button
                                                        type="button"
                                                        className="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 bg-white rounded-md border border-transparent transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none dark:bg-gray-800 dark:text-gray-400 dark:hover:text-gray-300"
                                                    >
                                                        Settings
                            ...
                            {hasPermission('view_operational_houses') && (
                                <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                    <NavLink
                                        ...
                                        active={route().current('operational-houses.*')}
                                    >
                                        Operational Laweyan
                                    </NavLink>
                                </div>
